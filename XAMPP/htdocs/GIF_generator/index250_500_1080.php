                ...
                if($contenido_ref == "360") {
                    ...
                    foreach($contenidos_360_limpio as $fotograma) {
                        ...
                        if(substr($fotograma, -4) == ".jpg") {
                            ...
                            $image2->readimage($_SERVER['DOCUMENT_ROOT'].'/GIF_generator/clonado_ftp/'.$ref.'/360/'.$fotograma);
                            $image3->readimage($_SERVER['DOCUMENT_ROOT'].'/GIF_generator/clonado_ftp/'.$ref.'/360/'.$fotograma);
                            ...
                            $carpeta = $_SERVER['DOCUMENT_ROOT'].'/GIF_generator/clonado_ftp/'.$ref.'/2';
                            if (!file_exists($carpeta)) {
                                mkdir($carpeta, 0777, true);
                            }
                            $image2->writeImage($_SERVER['DOCUMENT_ROOT'].'/GIF_generator/clonado_ftp/'.$ref.'/2/'.substr($fotograma, 0, -4).'.gif');
                            $carpeta2 = $_SERVER['DOCUMENT_ROOT'].'/GIF_generator/clonado_ftp/'.$ref.'/3';
                            if (!file_exists($carpeta2)) {
                                mkdir($carpeta2, 0777, true);
                            }
                            $image3->writeImage($_SERVER['DOCUMENT_ROOT'].'/GIF_generator/clonado_ftp/'.$ref.'/3/'.substr($fotograma, 0, -4).'.gif');
                    ...
                    $file = fopen("genera_gif_250_500_1080.bat", "a");
