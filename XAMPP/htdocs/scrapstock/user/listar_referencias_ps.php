...
if(!isset($_SESSION['user'])) { //Se intenta acceder a la aplicación sin un login correcto
    ...
    if (isset($_SESSION['filtro_ps'])) {
        $filtro = $_SESSION['filtro_ps'];
    } else {
        $filtro = "todos";
    }
    ...
    if ($filtro == "todos") {
         $consulta_referencias = "SELECT DISTINCT refs_ps_referencia
                                    FROM refs_ps
                                    ORDER BY refs_ps_referencia ASC
                                    LIMIT $ref_por_pag OFFSET $offset;";
        
        $consulta_referencias_prev = "SELECT DISTINCT refs_ps_referencia
                                        FROM refs_ps;";
        ...
        $consulta_referencias = "SELECT DISTINCT refs_ps_referencia
                                FROM refs_ps
                                WHERE refs_ps_categoria LIKE '$categoria'
                                ORDER BY refs_ps_referencia ASC
                                LIMIT $ref_por_pag OFFSET $offset;";
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <h4 class="enmarcado2 indentado text-center">Listado de Referencias de ps</h4>
            ...
            <div class="col-md-4 col-md-offset-3 text-center margin_inf">
                ...
                <div class="form-group">                
                    <select class="form-control" name="filtro" id="filtro">
                        ...
                        $consulta_categorias = "SELECT DISTINCT refs_ps_categoria
                                                    FROM refs_ps
                                                    ORDER BY refs_ps_categoria ASC";
    
                        $resultado_consulta_categorias = $bd->Execute($consulta_categorias);
                        
                        while (!($resultado_consulta_categorias->EOF)) {
                            $nombre_categoria = $resultado_consulta_categorias->fields['refs_ps_categoria'];
                            
                            ?>
                            <option value="<?php echo $nombre_categoria; ?>" id="<?php echo preg_replace('[&]', "", preg_replace('[,]', "", preg_replace('[ñ]', "", preg_replace('[/]', "", preg_replace('[\s+]', "", $nombre_categoria))))); ?>" class="capitalize"><?php echo $nombre_categoria; ?></option>
                            <?php
            ...
            <nav>
                <ul class="pager linea_nav">
                    ...
                    if($pag == 1) {
                        ...
                        ?>
                        <li>
                            <a href="inicio.php?id=listar_referencias_ps&pag=<?php echo ($pag-1); ?>">
                                <span aria-hidden="true">&laquo;</span> Pág. Anterior
                            </a>
                        </li>
                        <?php
                    ...
                    if($pag == $num_paginas) {
                        ...
                        ?>
                        <li>
                            <a href="inicio.php?id=listar_referencias_ps&pag=<?php echo ($pag+1); ?>" aria-label="Previous">
                                Pág. Siguiente <span aria-hidden="true">&raquo;</span>
                            </a>
                        </li>
                        <?php
            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    <tr id="cabecera_listado">
                        ...
                        <th class="info celdacentradahor celdacentradavert"><i class="glyphicon glyphicon-barcode"></i> Ref. ps</th>
                ...
                while (!($resultado_consulta_referencias->EOF)) {
                    $articulo_ref = $resultado_consulta_referencias->fields['refs_ps_referencia'];
                    
                    $consulta_datos_referencia = "SELECT * FROM refs_ps
                                                    WHERE refs_ps_referencia LIKE '$articulo_ref'
                                                    LIMIT 1;";
                    $resultado_consulta_datos_referencia = $bd->Execute($consulta_datos_referencia);
                    
                    $articulo_url_imagen = $resultado_consulta_datos_referencia->fields['refs_ps_url_imagen'];
                    
                    $articulo_nombre = $resultado_consulta_datos_referencia->fields['refs_ps_nombre'];$articulo_categoria = $resultado_consulta_datos_referencia->fields['refs_ps_categoria'];
                    $articulo_subcategoria = $resultado_consulta_datos_referencia->fields['refs_ps_subcategoria'];
            ...
            <nav aria-label="Page navigation" class="text-center">
                <ul class="pagination linea_nav2">
                    ...
                    for($i=1; $i<= $num_paginas; $i++) {
                        ...
                        if($i == $pag) {
                            ?>
                            <li class="active"><a href="inicio.php?id=listar_referencias_ps&pag=<?php echo $i; ?>" class="btn_pg_<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php
                        } else {
                            ?>
                            <li><a href="inicio.php?id=listar_referencias_ps&pag=<?php echo $i; ?>" class="btn_pg_<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php
                        }
