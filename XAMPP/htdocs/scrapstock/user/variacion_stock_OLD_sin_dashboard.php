    ...
    if(isset($_GET['ref'])) {
        ...
        while ($dia <= $dias_diferencia) {
            ...
            if($resultado_consulta_stocks_dia->fields['stock_makito_vs_todos_fecha'] != "") {
                ...
                $array_stock_dia = array($fecha_dia, $stock_cifra_dia, $stock_giving_dia, $stock_mob_dia, $stock_ps_dia, $stock_pf_dia, $stock_ggoya_dia);
            ...
            var data = google.visualization.arrayToDataTable([
              ...
              <?php
                ...
                foreach ($array_stocks_dias as $stocks_dia) {
                    $array_str = "['".$stocks_dia[0]."', ".$stocks_dia[1].", ".$stocks_dia[2].", ".$stocks_dia[3].", ".$stocks_dia[4].", ".$stocks_dia[5].", ".$stocks_dia[6]."]";
        ...
        <div class="container" id="cuerpo_home">
            ...
            <!--DIV que mostrará los diagramas de resultado-->
